...
<head>
    <meta charset="utf-8" />
    <title>Error Page | {{ $code }} | {{ $message }}</title>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Return to <a href="javascript:history.back()"
                                    class="text-white ml-1"><b>Kembali</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
