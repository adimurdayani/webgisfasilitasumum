                ...
                <div class="card-box ribbon-box">
                    ...
                    <div class="ribbon-content">
                        ...
                        <form action="{{ route('app.settings.update-social-login',socialLogin(1)) }}" method="post">
                            ...
                            <label>{{__('Facebook Visibility')}}</label>
                    ...
                    <div class="ribbon-content">
                        ...
                        <label>{{__('Google Visibility')}}</label>
                        <div class="form-inline mb-4">
                            <div class="custom-control custom-radio mr-4">
                                ...
                                true ? 'checked' : '' }}
                                class="custom-control-input">
                                <label class="custom-control-label" for="customRadio3">{{__('Show')}}</label>
                            </div>
                            <div class="custom-control custom-radio">
                                ...
                                false ? 'checked' : '' }}
                                class="custom-control-input">
                                <label class="custom-control-label" for="customRadio4">{{__('Hide')}}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ribbon-content">
                        ...
                        <label>{{__("Github Visibility")}}</label>
                        <div class="form-inline mb-4">
                            <div class="custom-control custom-radio mr-4">
                                ...
                                == true ? 'checked' : '' }}
                                class="custom-control-input">
                                <label class="custom-control-label" for="customRadio5">{{__("Show")}}</label>
                            </div>
                            <div class="custom-control custom-radio">
                                ...
                                == false ? 'checked' : '' }}
                                class="custom-control-input">
                                <label class="custom-control-label" for="customRadio6">{{__("Hide")}}</label>
                            </div>
                        </div>
