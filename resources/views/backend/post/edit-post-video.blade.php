...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('app.posts.update-video',$post->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card-box ribbon-box">
                        ...
                        <div class="ribbon-content">
                            ...
                            <div class="text-center mb-2">
                                <img src="{{ asset('storage/public/img/'.$post->img_thumb_video) }}"
                                    class="img-thumbnail mb-2" width="50%" alt="Image Post" loading="lazy">
                            </div>
