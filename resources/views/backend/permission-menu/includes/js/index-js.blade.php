    ...
    $(document).ready(function(){
        $('#table-permission').DataTable({
            ...
            columns: [
                ...
                { data: 'name.slug', name: 'name.slug', render:function(data,row,value){
                    return value.name+' <code>('+value.slug+')</code>'
                } },
                { data: 'created_at', name: 'created_at', className:'text-center'},
                { data: 'id', name: 'id', className:'text-center', render:function(data){
                    return '<div class="btn-group">'+
                                '<a href="#" class="btn btn-sm btn-warning" data-target="#edit'+data+'" data-toggle="modal"><i class="fe-edit"></i> Edit</a>'+
