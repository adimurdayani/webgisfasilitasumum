...
<script>
    $(document).ready(function(){
        $('#table-region').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("app.regions.load-data") }}',
                cache:false,
            },
            columns: [
        ...
        $("#table-region").on('click','.hapus-data[data-id]',function(e){
            e.preventDefault();
            var id = $(this).data("id");
            Swal.fire({
        ...
        $("#table-region").on('click','.edit-data[data-id]',function(e){
            e.preventDefault();
            $('#edit').modal('show');
            var id = $(this).data("id");

            $.ajax({
                url: "{{ route('app.regions.show') }}",
                type: 'GET',
                dataType: "JSON",
                data: {
                    "id": id
