            ...
            <div class="col-lg-12">
                <div class="card-box ribbon-box">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped w-100" id="table-region">
                            <thead>
                                <tr>
...
@include('backend.region.includes.modal.modal')

@endsection

@include('backend.region.includes.js.index-js')