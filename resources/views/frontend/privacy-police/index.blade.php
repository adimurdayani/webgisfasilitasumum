...
<section class="wrapper image-wrapper bg-image bg-cover bg-overlay text-white"
    data-image-src="{{ asset('assets/frontend') }}/img/banner-1.png">
            ...
            <section id="privacy-policy" class="wrapper pt-16">
                <div class="card">
                    <div class="card-body p-10">
                        <h2 class="mb-3">Privacy Policy for Dinas Komunikasi dan Informatika kota Palopo</h2>

                        <p>At Dinas Komunikasi dan Informatika kota Palopo, accessible from smartcity.palopokota.go.id,
                            one of our main priorities is the privacy of our visitors. This Privacy Policy document
                            contains types of information that is collected and recorded by Dinas Komunikasi dan
                            Informatika kota Palopo and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Dinas Komunikasi
                            dan Informatika kota Palopo. This policy is not applicable to any information collected
                            offline or via channels other than this website. Our Privacy Policy was created with the
                            help of the <a href="https://postsrc.com/tools/privacy-policy-generator">PostSrc Privacy
                        ...
                        <p>Dinas Komunikasi dan Informatika kota Palopo follows a standard procedure of using log files.
                        ...
                        <p>Like any other website, Dinas Komunikasi dan Informatika kota Palopo uses 'cookies'. These
                        ...
                        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                            Dinas Komunikasi dan Informatika kota Palopo.</p>

                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on Dinas
                            Komunikasi dan Informatika kota Palopo, which are sent directly to users' browser. They
                        ...
                        <p>Note that Dinas Komunikasi dan Informatika kota Palopo has no access to or control over these
                            cookies that are used by third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>Dinas Komunikasi dan Informatika kota Palopo's Privacy Policy does not apply to other
                        ...
                        <p>Dinas Komunikasi dan Informatika kota Palopo does not knowingly collect any Personal
